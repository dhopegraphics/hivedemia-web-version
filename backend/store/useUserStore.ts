  ...
  return {
    ...
    fetchProfileFromSupabase: async () => {
      ...
      try {
        ...
        if (ErrorRecovery.handleAuthError(e)) {
          // Auth error was handled, clear profile and set appropriate error
          smartSet({ profile: null, error: "Authentication required" });
        } else {
    ...
    getUserProfile: async (userId: string): Promise<UserProfile | null> => {
      ...
      try {
        ...
        // Use centralized auth error handler
        ErrorRecovery.handleAuthError(err);
